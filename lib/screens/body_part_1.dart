...
class _BodyPart1State extends State<BodyPart1> {
  ...
  void initState() {
    ...
    featuredPosts = posts.where((element)=>element['postType'] == 'FEATURED').toList();
              ...
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                  ...
                  itemBuilder: (ctx, index) {
                    if(index == displayPosts.length && displayPosts.length != featuredPosts.length){
                      return Container(
                    ...
                    return OpenContainer(
                      transitionType: ContainerTransitionType.fade,
                        ...
                        return Row(
                          children: [
                            index == featuredPosts.length ? const SizedBox.shrink() : BodyPart1Item(
                        ...
                        return ViewFBPost(
                          ...
                          attachement: displayPosts[index].containsKey('subattachments') ? displayPosts[index]['subattachments'] : [],
                          media: displayPosts[index]['media'],
                          type: displayPosts[index].containsKey('type') ? displayPosts[index]['type'] : '',
                        );
                        }
                    );
                  }
